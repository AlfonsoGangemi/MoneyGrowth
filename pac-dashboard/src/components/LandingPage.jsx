      ...
      <footer className="border-t border-slate-800 py-6 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-between gap-3 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-4">
            <a href="/privacy" onClick={(e) => { e.preventDefault(); window.open('/privacy', '_blank') }} className="hover:text-slate-300 transition-colors cursor-pointer">{t('footer_privacy')}</a>
            <a href="/termini" onClick={(e) => { e.preventDefault(); window.open('/termini', '_blank') }} className="hover:text-slate-300 transition-colors cursor-pointer">{t('footer_termini')}</a>
