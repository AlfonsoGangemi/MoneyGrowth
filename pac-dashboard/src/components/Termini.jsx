...
function TerminiIT() {
  return (
    <div className="space-y-6 text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
      ...
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">4. Dati dell'utente</h2>
      ...
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">5. Modifiche al servizio</h2>
        <p>Ci riserviamo il diritto di modificare o interrompere il servizio in qualsiasi momento senza preavviso.</p>
      </section>
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">6. Legge applicabile</h2>
...
function TerminiEN() {
  return (
    <div className="space-y-6 text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
      ...
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">4. User Data</h2>
      ...
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">5. Changes to the Service</h2>
        <p>We reserve the right to modify or discontinue the service at any time without notice.</p>
      </section>
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">6. Governing Law</h2>
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100">
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-8">{t('termini_title')}</h1>
