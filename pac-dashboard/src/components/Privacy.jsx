...
function PrivacyIT() {
  return (
    <div className="space-y-6 text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
      ...
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">2. Dati raccolti</h2>
      ...
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">3. Finalità del trattamento</h2>
      ...
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">4. Base giuridica</h2>
      ...
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">5. Conservazione dei dati</h2>
      ...
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">6. Condivisione con terze parti</h2>
        <p>Non vendiamo né condividiamo i tuoi dati con terze parti. I dati sono archiviati su Supabase (infrastruttura cloud), il cui utilizzo è regolato dalla <a href="https://supabase.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300">Privacy Policy di Supabase</a>.</p>
      </section>
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">7. I tuoi diritti</h2>
...
function PrivacyEN() {
  return (
    <div className="space-y-6 text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
      ...
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">2. Data Collected</h2>
      ...
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">3. Purpose of Processing</h2>
      ...
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">4. Legal Basis</h2>
      ...
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">5. Data Retention</h2>
      ...
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">6. Third-Party Sharing</h2>
        <p>We do not sell or share your data with third parties. Data is stored on Supabase (cloud infrastructure), whose use is governed by <a href="https://supabase.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300">Supabase's Privacy Policy</a>.</p>
      </section>
      <section>
        <h2 className="text-slate-900 dark:text-white font-semibold text-base mb-2">7. Your Rights</h2>
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-100">
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white mb-8">{t('privacy_title')}</h1>
