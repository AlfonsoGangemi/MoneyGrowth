export default {
  ...
  faq_2_q: 'Quali sono le principali caratteristiche di un ETF?',
  ...
  faq_3_q: "Come si acquista un ETF?",
  ...
  faq_4_q: "Cos'è un PAC (Piano di Accumulo Capitale)?",
  ...
  // --- Piattaforma ---
  faq_5_q: 'Perché è importante analizzare il proprio portafoglio ETF?',
  ...
  faq_7_q: 'Posso usare ETF Lens con più broker?',
  ...
  faq_8_q: 'Posso importare i miei dati da un CSV o da un altro strumento?',
  ...
  // --- Integrazione AI ---
  faq_9_q: 'Posso analizzare il mio portafoglio con Claude o un altro AI?',
  faq_9_a: "Sì. ETF Lens supporta il protocollo MCP (Model Context Protocol): Claude Code e Claude Desktop possono connettersi direttamente ai tuoi dati e rispondere in linguaggio naturale.<br><br>Il metodo consigliato è <strong>OAuth 2.1 con PKCE</strong>: aggiungi semplicemente l'URL del server (<code>https://etflens.app/api/mcp</code>) nelle impostazioni MCP del tuo client AI, senza inserire credenziali. Il client avvia automaticamente il flusso di autorizzazione — ti verrà chiesto di accedere a ETF Lens e di dare il consenso. Il token di accesso scade dopo 1 ora e viene rinnovato in background dal client.<br><br>In alternativa puoi usare una <strong>chiave API Bearer</strong> generata dalla dashboard (Impostazioni → API key): utile per client AI che non supportano ancora OAuth.",
  faq_10_q: 'Cosa posso chiedere a Claude collegato a ETF Lens?',
  ...
  // --- Sicurezza ---
  faq_11_q: 'I miei dati sono al sicuro?',
  ...
  faq_12_q: 'Quali misure tecniche proteggono i miei dati?',
