export default {
  ...
  // --- General ---
  faq_1_q: '[General] What is an ETF?',
  ...
  faq_2_q: '[General] What are the main characteristics of an ETF?',
  ...
  faq_3_q: '[General] How do you buy an ETF?',
  ...
  faq_4_q: '[General] What is a PAC (savings accumulation plan)?',
  ...
  // --- Platform ---
  faq_5_q: '[Platform] Why is it important to analyse your ETF portfolio?',
  ...
  faq_6_q: '[Platform] Does ETF Lens have a cost?',
  ...
  faq_7_q: '[Platform] Can I use ETF Lens with multiple brokers?',
  ...
  faq_8_q: '[Platform] Can I import my data from a CSV or another tool?',
  ...
  // --- AI Integration ---
  faq_9_q: '[AI Integration] Can I analyse my portfolio with Claude or another AI?',
  faq_9_a: 'Yes. ETF Lens supports the MCP (Model Context Protocol): Claude Code and Claude Desktop can connect directly to your data and answer questions in natural language. After generating an API key from the dashboard (Settings → API key), add the server in the MCP settings of your AI client.',
  faq_10_q: '[AI Integration] What can I ask Claude when connected to ETF Lens?',
  ...
  // --- Security ---
  faq_11_q: '[Security] Is my data secure?',
  ...
  faq_12_q: '[Security] What technical measures protect my data?',
