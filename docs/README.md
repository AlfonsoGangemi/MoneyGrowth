...
| [deploy.md](deploy.md) | Deploy su Vercel: pipeline di build e prerendering SEO, Build Command obbligatorio, variabili d'ambiente, rewrite `vercel.json`, DNS e cache Cloudflare |
